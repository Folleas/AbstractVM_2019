...
VM::Int8::Int8(const int8_t value)
{
    this->_value = value;
}

std::string VM::Int8::toString() const
{
    return (std::to_string(this->_value));
}

IOperand *VM::Int8::operator+(const IOperand &rhs) const
{
    IOperand *tmp;

    switch (rhs.getType()) {
        case eOperandType::Int8 :
            tmp = Factory::createOperand(eOperandType::Int8, std::to_string(std::stoi(this->toString()) + std::stoi(rhs.toString())));
            break;
...
IOperand *VM::Int8::operator%(const IOperand &rhs) const
{
    ...
    switch (rhs.getType()) {
        ...
        case eOperandType::Int32 :
            ...
            break;
        case eOperandType::Float :
            tmp = Factory::createOperand(eOperandType::Float, std::to_string(std::fmod(std::stof(this->toString()), std::stoi(rhs.toString()))));
            break;
        case eOperandType::Double :
